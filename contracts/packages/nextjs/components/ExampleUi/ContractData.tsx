...
export default function ContractData() {
  ...
  const openBattlesLength: number = battles ? battles.filter(battle => battle.status === Status.Open).length : 0;
      ...
      <div className="flex flex-col max-w-md bg-base-200 bg-opacity-70 rounded-2xl shadow-lg px-5 py-4 w-full">
        <div className="flex justify-between w-full">
          ...
          <div className="bg-secondary border border-primary rounded-xl flex">
            <div className="p-2 py-1 border-r border-primary flex items-end">Total Battles</div>
            <div className="text-4xl text-right min-w-[3rem] px-2 py-1 flex justify-end font-bai-jamjuree">
              {battles?.length?.toString() || "0"}
            </div>
          </div>

          <div className="bg-secondary border border-primary rounded-xl flex">
            <div className="p-2 py-1 border-r border-primary flex items-end">Open Battles</div>
            <div className="text-4xl text-right min-w-[3rem] px-2 py-1 flex justify-end font-bai-jamjuree">
              {openBattlesLength.toString() || "0"}
            </div>
          </div>
        </div>
